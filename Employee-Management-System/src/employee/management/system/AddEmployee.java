...
public class AddEmployee extends JFrame implements ActionListener {
    ...
    AddEmployee() {
        ...
        createTable(); // Automatically create the table
    }
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == add) {
            ...
            try (PreparedStatement ps = new Conn().c.prepareStatement(query)) {
                ps.setString(1, tfname.getText());
                ps.setString(2, tffname.getText());
                ps.setString(3, ((JTextField) dcdob.getDateEditor().getUiComponent()).getText());
                ps.setString(4, tfsalary.getText());
                ps.setString(5, tfaddress.getText());
                ps.setString(6, tfphone.getText());
                ps.setString(7, tfemail.getText());
                ps.setString(8, (String) cbeducation.getSelectedItem());
                ps.setString(9, tfdesignation.getText());
                ps.setString(10, tfaadhar.getText());
                ps.setString(11, lblempId.getText());
